...
class LineFollowerController(Node):
    def __init__(self):
        ...
        self.declare_parameter('control.speed.default', 0.0)
        self.declare_parameter('control.pid.Kp', 0.0)
        self.declare_parameter('control.pid.Ki', 0.0)
        self.declare_parameter('control.pid.Kd', 0.0)

        self.declare_parameter('control.max_v', 0.0)
        self.declare_parameter('control.min_v', 0.0)
        self.declare_parameter('control.max_w', 0.0)
        self.declare_parameter('control.min_w', 0.0)
